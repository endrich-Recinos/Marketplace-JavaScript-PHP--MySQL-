...
<div class="community">
    ...
    <h3 class="post_email"><?= $post_result['name']; ?></h3>
     ...
     <h6> <label style="color:red"><?php echo " Date: " ?></label> <?php echo $post_result['date']." at"."  ".$post_result['time'];?></h6></div>
     	...
     	<label style="margin-left: 3%;border-bottom: 1px solid gray;width: 70%">Comentarios</label>
     ...
     <button class="btn btn-info button_comment" name="comment_button">comentario</button><br><br>
     </div>
     </form>
     	<?php endif; ?>
     	</div>
