...
<body>
	...
	<div class="check_out_item">
		<h3>Objetos en tu carro de compras</h3>
...
<!--                    <img src="../images/logo.png">-->
	...
	<a href="index.php"> <button class="check_out_item_continue">Seguir comprando</button></a>

	<div class="check_out_item_proceed">
		<p style="font-size: 20px;">
			Productos : $ <?= $sum; ?><br>
			Envio&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: $ <?= $shippingCost=100; ?><br>
			Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: $ <?= $grandTotal = ($sum + $shippingCost); ?>

			<a href="payment.php"><button <?php  if ($empty==''){ ?> disabled <?php   } ?> class="btn">Pasar a pagar</button></a>
		</p>
	</div>
