...
<head>
  <meta charset="UTF-8">
  <title>Bienvenido <?= $user_name ?></title>
      ...
      <?php include "header.php" ?>
          ...
          <p><?= $email ?></p>
                ...
                <?php $_SESSION['email'] = $email ?>
                    <a href="../login-system/delete.php"><button class="btn btn-default" style="margin-bottom: 20px" onclick="return confirm_delete()">Borrar Cuenta</button></a>
          </div>
          </div>
          ...
          <?php if (($_SESSION['account_type'])== 'Business') :?>
            ...
            <div style="margin-left: 85%;">
              <a href="new_store_description.php"> <button <?php if ($active == '0'){ ?> disabled <?php   } ?> class="btn btn-primary"  style="margin: 20px;margin-right: 50px ;border: none;">Ir a la tienda</button>
              </a>
            </div>
...
<script>
  ...
  function confirm_delete(){
        return confirm("¿Está seguro de que desea eliminar estos datos de forma permanente?");
    }
