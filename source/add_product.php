  ...
  <form action="../seller/storeProductList.php" method="post" enctype="multipart/form-data">
    ...
    <div style="border: 1px solid gray;margin-left: 10%;margin-right: 10%;border-radius: 10px;margin-bottom: 30px">
     ...
     <div style="margin: 30px;">
      ...
      +límite máximo de imagen 2mb formato jpg o png<input type="file" name="productPic" style="display: none;" accept="image/*" id="product_select"/>
      </label>
      ...
      <?php if ($edit_state == false): ?>
       ...
       <div>
         ...
         <select name="productFor" style="border-radius: 10px;cursor: pointer;" id="continent" onchange="countryChange(this);" required>
          ...
          <option name="itemFor" value="Men\'s Fashion">Ropa de hombres</option>
          <option name="itemFor" value="Women\'s Fashion">Ropa de mujer</option>
          <option name="itemFor" value="Baby\'s Fashion">Ropa de bebes</option>
          <option name="itemFor" value="Phone and Tablets">Telefono y Tabletas</option>
          <option name="itemFor" value="Electronics">Electronicos</option>
          <option name="itemFor" value="Home and Living">Vida en el hogar</option>
          <option name="itemFor" value="Sports and Travels">Deportes y Viajes</option>
