...
<body>
    ...
    <div class="form">
        ...
        <p style="font-size: 20px;">
            Tu pedido en Byznez.com está completo.<br>
            Su pedido será enviado muy pronto.<br>
            Para obtener más información, comuníquese con nuestro servicio de atención al cliente.<br>
